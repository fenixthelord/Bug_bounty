...
<footer class="footer footer-static footer-light">
    <p class="clearfix mb-0">
        ...
        <span class="float-right d-sm-inline-block d-none">Designed<i class="bx bxs-heart pink mx-50 font-small-3"></i>
            by <a class="text-uppercase" href="https://fb.com/fenix.p2h" target="_blank">Qusai 😎</a></span>
