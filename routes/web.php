...
// Home Route
Route::get('/Admins', [DashboardController::class, 'index'])->name('Admin-Panel');
...
Route::patch('/researcher/restore/{id}', [ResearcherController::class, 'restore'])->name('restore.researcher');
Route::get('/researcher/trashed', [ResearcherController::class, 'trashed'])->name('trashed.researcher');

Route::delete('/researcher/{id}/force-delete', [ResearcherController::class, 'forceDelete'])->name('researcher.forceDelete');
});
//--------------------------------------------------------------------------------------
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/home/specializations/trashed', [SpecializationController::class, 'trashed'])
...
Route::prefix('/admin')->middleware('auth')->group(function() {
    ...
    Route::delete('company/{company}/force-delete', [CompanyController::class, 'forceDelete'])->name('company.forceDelete');
});
//--------------------------------------------------------------------------------------
// Report Routes
Route::middleware('auth')->group(function () {
